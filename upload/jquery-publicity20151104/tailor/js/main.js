...
$(function () {
    ...
    $(".sc_btn").on("click",function(){
        ...
        $("#pic").attr("action","../../../file/uploadAndCut.do?"+id);
        $("#pic").submit();
    });
    // $(window.parent.document).find("#layui-layer-iframe1").load(function () {
    //     var main = $(window.parent.document).find("#layui-layer-iframe1");
